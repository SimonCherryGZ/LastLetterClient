...
public class ValidationCode extends View{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for(int i=1;i<=length;i++){
            ...
            mTextPaint.setColor(getResources().getColor(R.color.colorPrimaryTextDark));
            //canvas.drawText(String.valueOf(mCodeString.charAt(i - 1)), (i-1) * charLength * 1.6f+30, mHeight * 2 / 3f, mTextPaint);
            canvas.drawText(String.valueOf(mCodeString.charAt(i - 1)), (i-1) * charLength * 1.3f+5, mHeight * 3 / 4f, mTextPaint);
            canvas.restore();
        }
        // 产生干扰效果1 -- 干扰点
    ...
    private void init() {
        ...
        mTextPaint.setStrokeWidth(4); // 画笔大小为3
